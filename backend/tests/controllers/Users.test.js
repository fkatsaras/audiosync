...
test.serial('Login fails with non-existent user', async (t) => {
    ...
    t.is(response.code, 404);  // Expecting 404 or similar response code for user not found
    t.is(response.message, 'Invalid username');  // The message should indicate the user was not found
});
